...
//   var ctx = context().step(30).size($("#voltage-graph-area").width());

//   d3.select("#voltage-graph-area")
//     .selectAll(".axis")
//     .data(["top", "bottom"])
//     .enter()
//     .append("div")
...
//     })
//     .each(function (d) {
//       ctx.axis().ticks(12).orient(d).render(d3.select(this));
//     });

//   const r = d3
//     .select("#voltage-graph-area")
//     .append("div")
//     .attr("class", "rule");
...
//     .data(
//       d3
//         .range(0, Object.keys(current_voltage_points).length)
//         .map(generateGraphPoints)
//     )
//     .enter()
//     .insert("div", ".bottom")
//     .attr("class", "horizon");
//   const range = Math.max(
//     ...deviceConfig["channel_info"].map((e) => e["voltage_range"])
//   );
//   ctx
//     .horizon()
//     .extent([-range, range])
//     .height(
//       $("#voltage-graph-wrapper").height() / deviceConfig["channel_info"].length
//     )
//     .render(h);
